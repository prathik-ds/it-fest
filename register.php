    ...
    <div style="max-width: 480px; width: 100%;">
        ...
        <div class="glass" style="padding: 44px 36px; border-color: rgba(0, 212, 255, 0.12);">
            ...
            <div style="text-align: center; margin-bottom: 36px;">
                ...
                <h2 style="font-family: 'Space Grotesk', sans-serif; font-size: 1.6rem; font-weight: 700; margin-bottom: 8px; background: var(--grad-cool); -webkit-background-clip: text; background-clip: text; -webkit-text-fill-color: transparent;">Join NEXUS</h2>
