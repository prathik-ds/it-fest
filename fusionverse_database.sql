-- FusionVerse Database Full Structure
...
INSERT IGNORE INTO `events` (`id`, `name`, `category`, `description`, `rules`, `date`, `time`, `venue`, `max_participants`, `is_team_event`, `min_team_size`, `max_team_size`) VALUES
(1, 'Code Rush', 'IT', 'Fast-paced coding competition where logic meets speed.', 'Individual. No internet allowed.', '2026-04-10', '10:00:00', 'Lab 1', 50, 0, 2, 4),
(2, 'Biz Quiz', 'Commerce', 'Test your business knowledge and strategy across rounds.', 'Team of 2. Buzzer format.', '2026-04-10', '11:30:00', 'Main Auditorium', 100, 1, 2, 2),
(3, 'Fusion Hack', 'IT', 'Build the future in this intensive 12-hour build-a-thon.', 'Team of 3-4. Innovative solutions only.', '2026-04-11', '09:00:00', 'Arena North', 30, 1, 3, 4);
